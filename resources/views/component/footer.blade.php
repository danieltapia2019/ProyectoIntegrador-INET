<footer class="footer">
    <div class="lista">
        <ul>
            ...
            <li><a href="{{ url('/curso/todos') }}"><i class="far fa-list-alt mr-2"></i>Cursos</a></li>
            <li><a href="{{ url('/home/faq') }}"><i class="far fa-question-circle mr-2"></i>Preguntas Frecuentes</a></li>
            <li><a href="{{ url('/home#contacto')}}"><i class="fas fa-mail-bulk mr-2"></i>Contacto</a></li>
        </ul>
    </div>
    <div class="info">
        <ul>
            ...
            <li>Powered by<i class="fab fa-html5 ml-3 html"></i><i class="fab fa-css3-alt ml-3 css"></i><i
                    class="fab fa-js ml-3 js"></i><i class="fab fa-php ml-3 php"></i><i
                    class="fab fa-laravel ml-3 lrl"></i></li>
        </ul>
    </div>
</footer>
