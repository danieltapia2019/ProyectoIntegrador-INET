...
<div class="conteiner">
  ...
  <div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="tipos" role="tabpanel" aria-labelledby="tipos-tab">
      ...
      <button type="button" class="btn btn-success mb-3" name="button" data-toggle="modal" data-target="#modalTipo">Agregar</button>
    ...
    <div class="tab-pane fade" id="usos" role="tabpanel" aria-labelledby="usos-tab">
      ...
      <button type="button" class="btn btn-success mb-3" name="button" data-toggle="modal" data-target="#modalUso">Agregar</button>
...
<!-- Modal Uso-->
<div class="modal fade" id="modalUso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
