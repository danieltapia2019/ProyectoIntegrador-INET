...
@section('content')
  <section>
    ...
    <div class="container">
            ...
            @forelse ($cursos as $curso)
                <div class="curso border-top-0 border-bottom-0 mb-2">
                    ...
                    <div class="item-desc p-2">
                        ...
                        <p class="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Excepturi ad voluptate expedita
                        iure? Maxime vel officiis accusantium fuga? Cumque ipsum quas nesciunt modi doloremque enim
                        libero fugit, molestias officia quisquam.12312121212121212222213123123123123123123213123123123123</p>
                    </div>
                    <div class="item text-center pt-4">
                        ...
                        <p clasS=font-weight-bold>
                            Lenguaje: <a href="">{{$curso->lenguaje}}</a>
                        </p>
        ...
        <div id=vacio1 display="none">No hay productos en su carrito.</div>
        @else
        <div id="vacio2">
